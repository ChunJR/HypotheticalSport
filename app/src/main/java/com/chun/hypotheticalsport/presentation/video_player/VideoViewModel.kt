...
import com.chun.hypotheticalsport.domain.model.VideoItem
...
class VideoViewModel @Inject constructor(
    ...
    init {
        player.prepare()
//        val matchJson = savedStateHandle.get<String>(Constants.VIDEO_PLAYER_ARGUMENT_KEY)
//        val match = Gson().fromJson(matchJson, Match::class.java)
//        Log.e("MATCHHHHHHH", match.toString())
    }
